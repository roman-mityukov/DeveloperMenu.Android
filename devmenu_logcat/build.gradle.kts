...
dependencies {
    ...
    implementation(Config.Dependency.LYNX)
...
this.ext.apply {
    set("moduleName", "Developer Menu Logcat")
    set("moduleArtifactId", "devmenu_logcat")
    set("moduleDescription", "Developer Menu Logcat")
}
