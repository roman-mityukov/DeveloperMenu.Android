...
dependencies {
    ...
    implementation(Config.Dependency.PLAY_SERVICES_LOCATION)
    implementation(Config.Dependency.PLAY_SERVICES_MAP)
...
this.ext.apply {
    set("moduleName", "Developer Menu Location")
    set("moduleArtifactId", "devmenu_location")
    set("moduleDescription", "Developer Menu Location")
}
