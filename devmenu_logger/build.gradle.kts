...
dependencies {
    ...
    implementation(Config.Dependency.LOG4J2_API)
    implementation(Config.Dependency.LOG4J2_CORE)
    implementation(Config.Dependency.LOG4J2_ANDROID)
    annotationProcessor(Config.Dependency.LOG4J2_CORE)
...
this.ext.apply {
    set("moduleName", "Developer Menu Logger")
    set("moduleArtifactId", "devmenu_logger")
    set("moduleDescription", "Developer Menu Logger")
}
